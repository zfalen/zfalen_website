    ...
    function(req, email, password, done) { // callback with email and password from form
        ...
        User.findOne({ 'local.email' :  email }, function(err, user) {
            ...
            if (!user.validPassword(password))
                return done(null, false, req.flash('loginMessage', 'Oh truck. Wrong password.')); // create the loginMessage and save it to session as flashdata
        ...
        process.nextTick(function() {
            ...
            User.findOne({ 'facebook.id' : profile.id }, function(err, user) {
                ...
                if (user) {
                    ...
                    // TELL ME WHAT THE FUCK IT LOOKS LIKE
                    console.log('The new user data: ' + newUser);
